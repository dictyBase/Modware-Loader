...
has '+input' => (
    documentation =>
        'Name of chado closure file. You need owltools(http://code.google.com/p/owltools) to generate the closure file. First install 
                                  owltools(http://code.google.com/p/owltools/wiki/InstallOWLTools) using the jar and script.
