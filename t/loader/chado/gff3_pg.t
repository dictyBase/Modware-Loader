...
use Modware::Loader::GFF3::Staging::Postgresql;


use_ok 'Modware::Loader::GFF3::Chado::Postgresql';
SKIP: {
...
my $staging_loader = Modware::Loader::GFF3::Staging::Postgresql->new(
    schema      => $schema,
    sqlmanager  => $sqllib,
...
my $loader = new_ok 'Modware::Loader::GFF3::Chado::Postgresql';
